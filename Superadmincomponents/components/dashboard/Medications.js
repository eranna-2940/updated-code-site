  ...
  return (
    ...
    <div className="col-xs-12">
      <div className="form-group form-horizontal row">
        <label className="col-xs-5 col-sm-3 col-md-2" htmlFor={`compliance_${index}`}>Compliance</label>
    ...
    <div className="col-xs-12">
      <div className="form-group form-horizontal row">
        <label className="col-xs-5 col-sm-3 col-md-2" htmlFor={`takes_as_prescribed_${index}`}>Takes as Prescribed</label>
        <div className="col-xs-7 col-sm-5 col-md-4">
          <label className="radio-inline me-4">
            <input
              type="radio"
