  ...
  return (
    ...
    <div className="d-flex ">
      ...
      <div className="col-sm-12 col-md-12 col-lg-10 p-0">
        ...
        <Link to='/dashboardPage' className="text-decoration-none"><i className="bi bi-house-fill"></i>&nbsp;Home&nbsp;</Link>&gt; Locations &gt; City
        </nav>
        ...
        <button className="btn btn-primary mb-2">
          <Link to="/addlocation" className="text-decoration-none text-white"><i className="fa fa-edit"></i> Add</Link>
        </button>
        </div>
